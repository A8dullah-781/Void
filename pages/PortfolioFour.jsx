...
const PortfolioFour = () => {
  return (
    <div className="flex fontone pt-[7vh] md:pt-0 flex-col bg-[#1c1c1c] justify-center items-center w-screen">
      <div className='md:h-[50vh] h-[40vh] rounded-3xl md:rounded-none md:m-0 m-4 lg:h-screen w-[90vw] md:w-screen flex justify-center items-start bg-[url("/images/portfolio/fourMain.webp")] bg-cover bg-center bg-no-repeat'>
      ...
      <div className="h-full py-8 md:py-16 px-[7.5vw] text-white fontone  w-screen">
        ...
        <div className="text-[4vw] text-center md:text-left md:text-[1.8vw] font-light leading-none mt-4">
          ...
          environment. The layout balances open workstations, private cabins,
          and meeting spaces to support diverse work styles. A refined material
          palette of wood, glass, and subtle stone finishes creates a cohesive
          identity, while strategic lighting and natural elements add warmth and
          depth. The result is a functional, visually strong workspace that
          reflects efficiency and contemporary corporate culture.
        </div>
      </div>
      ...
      <div className="flex flex-col  h-screen md:flex-row px-[7.5vw] py-4 md:h-[30vh] lg:h-[60vh] w-screen gap-4">
        <div className="h-full rounded-2xl w-[85vw] md:w-1/2 bg-[url('/images/portfolio/fourOne.webp')] bg-cover bg-center bg-no-repeat"></div>
        <div className="h-full rounded-2xl w-[85vw] md:w-1/2 bg-[url('/images/portfolio/fourTwo.webp')] bg-cover bg-center bg-no-repeat"></div>
      </div>
      <div className="flex flex-col mb-4 gap-4 ">
        <div className="h-[40vh] lg:h-[80vh] py-4 w-[85vw] bg-[url('/images/portfolio/fourThree.webp')] bg-cover bg-center bg-no-repeat rounded-2xl "></div>
        <div className="h-[40vh] lg:h-[80vh] py-4 w-[85vw] bg-[url('/images/portfolio/fourFour.webp')] bg-cover bg-center bg-no-repeat rounded-2xl "></div>
      </div>
    </div>
  );
};
