...
const PortfolioThree = () => {
  return (
    <div className="flex fontone pt-[7vh] md:pt-0 flex-col bg-[#1c1c1c] justify-center items-center w-screen">
      <div className='md:h-[50vh] h-[40vh] rounded-3xl md:rounded-none md:m-0 m-4 lg:h-screen w-[90vw] md:w-screen flex justify-center items-start bg-[url("/images/portfolio/threeMain.webp")] bg-cover bg-center bg-no-repeat'>
      ...
      <div className="flex flex-col  h-screen md:flex-row px-[7.5vw] py-4 md:h-[30vh] lg:h-[60vh] w-screen gap-4">
        <div className="h-full rounded-2xl w-[85vw] md:w-1/2 bg-[url('/images/portfolio/threeOne.webp')] bg-cover bg-center bg-no-repeat"></div>
        <div className="h-full rounded-2xl w-[85vw] md:w-1/2 bg-[url('/images/portfolio/threeTwo.webp')] bg-cover bg-center bg-no-repeat"></div>
      </div>
      <div className="flex flex-col mb-4 gap-4 ">
        <div className="h-[40vh] lg:h-[80vh] py-4 w-[85vw] bg-[url('/images/portfolio/threeThree.webp')] bg-cover bg-center bg-no-repeat rounded-2xl "></div>
        <div className="h-[40vh] lg:h-[80vh] py-4 w-[85vw] bg-[url('/images/portfolio/threeFour.webp')] bg-cover bg-center bg-no-repeat rounded-2xl "></div>
      </div>
    </div>
  );
};
