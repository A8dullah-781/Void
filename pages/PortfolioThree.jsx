  ...
  {portfolioThree.map((item, index) => (
    <div key={index} className="palet flex flex-col md:w-[20vw] w-[35vw] lg:w-[12vw] justify-center text-center items-center">
      ...
      <div className="flex flex-row px-[7.5vw] py-4 md:h-[30vh] lg:h-[60vh] w-screen gap-4">
        <div className="h-full rounded-2xl w-1/2 bg-[url('/images/portfolio/threeOne.png')] bg-cover bg-center bg-no-repeat"></div>
        <div className="h-full rounded-2xl w-1/2 bg-[url('/images/portfolio/threeTwo.png')] bg-cover bg-center bg-no-repeat"></div>
      </div>
