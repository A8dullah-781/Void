...
const Navbar = () => {
  ...
  return (
    <>
      {/* DESKTOP NAVBAR */}
      <div ref={navRef} className="hidden md:flex justify-center items-center fixed top-0 w-full z-50">
        <div className="bg-[#f2f2f238] glass w-[80vw] lg:w-[60vw] px-6 text-white m-2 rounded-2xl flex justify-between items-center h-[10vh]">
          <div>
            <img src="/images/logo.png" alt="Logo" className="w-[10vw]" />
          </div>
          <div className="flex text-[1.2vw] fontone gap-8">
            {[
              { name: "Home", id: "home" },
            ...
            <div
              ...
              className="relative bg-[#F2F2F2] overflow-hidden text-black hover:text-white py-2 px-3.5 rounded-3xl group cursor-pointer"
            >
      ...
      {/* MOBILE NAVBAR */}
      <div ref={navRef} className="md:hidden fixed top-0 w-full z-50 flex justify-between items-center px-5 py-4 bg-[#1C1C1C] text-white">
      ...
      >
        <div className="flex justify-end p-5 text-3xl cursor-pointer" onClick={() => setOpen(false)}>×</div>
        <div className="flex justify-center mt-2"><img src="/images/logo.png" className="w-[60vw]" /></div>
