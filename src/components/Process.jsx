  ...
  return (
    <div className="h-[400vh] hidden lg:block w-screen">
      ...
      >
        <div
          ref={headingRef}
          className="h-[30%] w-screen flex justify-center items-center flex-col text-white"
        >
          <div className="text-[4vw] font-bold">Our Process</div>
          <div className="text-[1.3vw] text-center font-extralight">
            A structured approach that transforms <br />
            ideas into meaningful spaces.
          </div>
        </div>
        ...
        <div className="h-[70%] w-screen px-[7.5vw] flex justify-center items-center">
          <div className="flex flex-row justify-between h-[80%] w-full">
            <div className="relative h-full w-[43%]">
              <div
                ref={addCardRef}
                className="glass rounded-3xl text-white p-2 h-[26vh] w-[13vw] absolute top-0 left-0 opacity-0"
              >
                ...
                <div className="h-[55%] flex flex-col justify-center items-center w-full">
                  ...
                  <div className="text-[0.8vw] text-center font-extralight">
                    We understand your vision, space, and requirements before
                    touching the design.
                  </div>
                </div>
              </div>
              ...
              <img
                ref={addImgRef}
                className="absolute top-[15%] left-[50%] opacity-0"
                src="/images/process/vone.webp"
                alt=""
              />

              <div
                ref={addCardRef}
                className="glass rounded-3xl text-white p-2 h-[26vh] w-[13vw] absolute bottom-0 right-0 opacity-0"
              >
                <div className="h-[45%] flex justify-center items-center w-full">
                ...
                <div className="h-[55%] flex flex-col -mt-2 justify-center items-center w-full">
                  ...
                  <div className="text-[0.8vw] text-center font-extralight">
                    We translate ideas into thoughtful layouts, materials, and
                    visual concepts.
                  </div>
                </div>
              </div>
            ...
            <div className="relative h-full w-[43%]">
              <img
                ref={addImgRef}
                className="absolute bottom-[15%] left-[-15%] opacity-0"
                src="/images/process/vtwo.webp"
                alt=""
              />
              ...
              >
                ...
                <div className="h-[55%] flex flex-col justify-center items-center w-full">
                  ...
                  <div className="text-[0.8vw] text-center font-extralight">
                    High-quality visuals help you experience the space before
                    execution.
                  </div>
                </div>
              </div>
