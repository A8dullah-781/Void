    ...
    <div id="about-wrapper">
      ...
      >
        <div className=" px-[7.5vw] pt-3 text-center md:text-left md:px-0 h-full bg-[#1C1C1C] text-[#F2F2F2] fontone flex flex-col items-center pr-[4vw] justify-center w-screen md:w-1/2 ">
          <div className="flex flex-col gap-4">
            ...
            <div className="text-[3.4vw] md:text-[1.3vw]">
              ...
              guided by a minimalist philosophy where form, material, and
              function are carefully considered. We believe strong interiors are
              not defined by excess, but by clarity spaces designed to support
              daily life while maintaining a calm and refined presence.
            </div>
        ...
        <div className="text-[3.5vw] text-center text-white fontone pt-5 md:hidden block">
          ...
          consistent: thoughtful design, precise execution, and lasting
          relevance.
        </div>
        <div
