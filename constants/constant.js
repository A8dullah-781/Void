...
const portfolioTwo = [
  {
    ...
    desc: "Accent walls & fluted panels.",
  },
  {
    color: "#708238",
    title: "Olive Green",
    desc: "Bed headboard & sofa fabric.",
  },
  {
    color: "#5C4033",
    title: "Walnut Brown",
    desc: "Wood furniture & stair steps.",
  },
  {
    color: "#D2B48C",
    title: "Warm Beige",
    desc: "Curtains, rugs, & cushions.",
  },
  {
    color: "#BDBDBF",
    title: "Bone White",
    desc: "Ceiling & main wall paint.",
  },
  {
    color: "#121212",
    title: "Matte Black",
    desc: "Lights, legs, & handles.",
  },
];
const portfolioThree = [
  {
    ...
    desc: "To provide a sleek, premium base.",
  },
  {
    color: "#B58863",
    title: "Warm Oak",
    desc: "To add warmth and organic texture.",
  },
  {
    color: "#000000",
    title: "Pure Black",
    desc: "To ensure a bold, professional equipment look.",
  },
  {
    color: "#FF9900",
    title: "Amber Glow",
    desc: "To create high-energy cinematic lighting.",
  },
  {
    color: "#DACDBA",
    title: "Soft Beige",
    desc: "To induce relaxation in wellness zones.",
  },
  {
    color: "#8E8E93",
    title: "Concrete Grey",
    desc: "To maintain a modern, industrial aesthetic.",
  },
];
const portfolioFour = [
  {
    ...
    desc: "Base walls and dark ceiling.",
  },
  {
    color: "#4A2C1D",
    title: "Dark Walnut",
    desc: "Vertical wall slats (texture).",
  },
  {
    color: "#E8E8E8",
    title: "Calacatta White",
    desc: "Marble reception desk & floor.",
  },
  {
    color: "#FFB347",
    title: "Golden Amber",
    desc: "Logo glow & LED strip accents.",
  },
  {
    color: "#4F4F4F",
    title: "Steel Grey",
    desc: "Furniture fabric & area rugs.",
  },
  {
    color: "#0A0A0A",
    title: "Obsidian Black",
    desc: "Glass frames & shadow areas.",
  },
];
